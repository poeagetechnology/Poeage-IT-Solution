...
export default function GetQuote() {
  ...
  return (
    <div className="bg-white min-h-screen text-gray-900">
      ...
      {/* HEADER */}
      <section className="py-16 text-center bg-gradient-to-r from-[#EAF2FF] to-white">
          ...
          {steps.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <p className={`text-xs mt-2 ${active ? "text-[#1E6DE0]" : "text-gray-500"}`}>
                  {s}
                </p>
