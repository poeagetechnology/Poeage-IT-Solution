...
export default function ContactUs() {
  ...
  return (
    <div className="bg-white text-gray-900 overflow-hidden">
      ...
      {/* ================= HERO ================= */}
      <section className="relative py-24 text-center bg-gradient-to-r from-green-100 to-white">

        {/* glow */}
        <div className="absolute top-0 left-0 w-60 h-60 bg-green-300 blur-3xl opacity-30" />
        <div className="absolute bottom-0 right-0 w-60 h-60 bg-green-400 blur-3xl opacity-20" />
      ...
      <section className="py-16 bg-green-50 text-center">
        ...
        >
          <Clock className="mx-auto text-green-600 mb-3" />
