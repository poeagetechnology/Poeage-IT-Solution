...
export default function FAQ() {
  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      {/* ================= HERO ================= */}
      <section className="py-24 text-center bg-gradient-to-br from-green-100 to-white relative overflow-hidden">
      ...
      <section className="max-w-3xl mx-auto px-6 -mt-10 relative z-20">
        ...
        <div className="bg-white border border-green-100 shadow-xl rounded-xl p-4 flex items-center gap-3">
      ...
      {/* ================= CTA ================= */}
      <section className="py-24 text-center bg-gradient-to-r from-green-500 to-green-600 text-white">
        ...
        <div className="flex justify-center gap-4">
          <button className="px-6 py-3 bg-white text-green-600 rounded-lg font-semibold shadow">
            Contact Support
          </button>
