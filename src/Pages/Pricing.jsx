...
export default function Pricing() {
  return (
    <div className="bg-white text-gray-900">
          ...
          {pricingTiers.map((tier, i) => (
            ...
            >
              <Card className="p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition">
                ...
                <p className="text-2xl font-bold text-[#1E6DE0] mb-4">
                  {tier.price}
                </p>
                  ...
                  <ul className="space-y-2 text-sm">
                    {tier.features.map((f, i) => (
                      <li key={i} className="flex items-center gap-2">
                        <span className="w-5 h-5 flex items-center justify-center rounded-full bg-[#EAF2FF] text-[#1E6DE0] text-xs">
                          ✓
                        </span>
                        {f}
                      </li>
      ...
      {/* COMPARISON */}
      <section className="py-14 px-6 bg-[#F3F6FF]">
        ...
        <div className="overflow-x-auto max-w-5xl mx-auto">
          <table className="w-full text-sm bg-white rounded-xl shadow border">
            ...
            <thead className="bg-[#EAF2FF] text-gray-600">
              <tr>
...
<section className="py-16 bg-[#F3F6FF] text-center">
  ...
  <div className="space-y-3 text-gray-600 text-sm">
    ...
    <div className="flex items-center justify-center gap-3">
      ...
      <p className="text-center">UPI, Credit/Debit Cards, Net Banking</p>
    </div>
    ...
    <div className="flex items-center justify-center gap-3">
      ...
      <p className="text-center">Monthly & Annual Billing</p>
    </div>
    ...
    <div className="flex items-center justify-center gap-3">
      ...
      <p className="text-center">10% Discount on Annual Plans</p>
    </div>
