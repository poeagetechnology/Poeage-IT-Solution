...
const features = [
  {
    icon: <CheckCircle className="text-[#1E6DE0]" />,
  ...
  {
    icon: <CheckCircle className="text-[#1CB7C8]" />,
...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-b from-white via-purple-50 to-white text-gray-900">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl px-6 text-white">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mt-6">
            ...
            <span className="text-[#1CB7C8]"> Modern Businesses</span>
          </h1>
      ...
      {/* CTA */}
      <section className="py-20 text-center bg-gradient-to-r from-[#1E6DE0] to-[#5A2DDB] text-white">
