  ...
  return (
    <div className="bg-gradient-to-b from-white via-indigo-50 to-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
                ...
                {categories.map((c) => (
                  <button
                    ...
                    className={`px-4 py-1 rounded-full text-sm border transition ${
                      category === c
                        ? "bg-[#1E6DE0] text-white"
                        : "text-gray-600 hover:bg-[#EAF2FF]"
                    }`}
                  >
                    {c}
                  </button>
                ...
                >
                  <Card className="overflow-hidden border shadow-sm hover:shadow-xl transition rounded-xl">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-xs text-[#1CB7C8] mb-1">
                        {article.category}
                      </p>
        ...
        {selected && (
          ...
          >
            ...
            <button
              ...
              className="text-sm text-[#1E6DE0] mb-6"
            >
              ← Back to Articles
            </button>
        ...
        {/* NEWSLETTER */}
        {!selected && (
          <div className="mt-20 text-center bg-gradient-to-r from-[#1E6DE0] to-[#5A2DDB] text-white p-10 rounded-xl">
