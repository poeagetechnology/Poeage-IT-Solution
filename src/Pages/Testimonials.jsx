  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      <motion.section
        ...
        animate="show"
        variants={container}
        className="py-20 text-center bg-gradient-to-r from-green-100 to-white"
      >
      ...
      >
        <motion.h2 variants={fadeUp} className="text-5xl font-bold text-green-600">
          {summary.average} ★
        </motion.h2>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-6 px-6">
          {[1, 2].map((v) => (
            ...
            >
              <Play className="text-green-500 mb-3" size={40} />
      ...
      <motion.section
        ...
        whileInView="show"
        variants={fadeUp}
        className="py-24 text-center bg-green-500 text-white"
      >
