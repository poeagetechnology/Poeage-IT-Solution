...
function NavLinkItem({ item, active }) {
  return (
    ...
    >
      ...
      <span
        className={`absolute left-0 -bottom-2 h-0.5 bg-green-500 transition-all ${
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
        ...
        {/* LOGO */}
        <Link to="/">
          <img src={Logo} className="h-10" alt="Poeage IT Solutions" />
        </Link>
        ...
        <div className="hidden md:flex gap-4 items-center">
          <Link to="/get-quote" className="text-gray-600 hover:text-green-600">
            Get Quote
          </Link>
